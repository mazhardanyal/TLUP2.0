            ...
            <div className="info-card">
              ...
              <div className="info-details">
                <div className="info-item">
                  ...
                  <div className="info-content">
                    <h4>Address</h4>
                    <p>LevelUp School System, Village Ali Shah U/C Akbarpura, Peshawar, Pakistan</p>
                  </div>
                </div>
                ...
                <div className="info-item">
                  ...
                  <div className="info-content">
                    <h4>Office Hours</h4>
                    <p>Monday - Saturday: 8:00 AM - 3:00 PM</p>
                    <p>Sunday: Closed</p>
                  </div>
                </div>
              </div>
              ...
              <div className="social-connect">
                ...
                <div className="social-icons">
                  <a href="https://www.facebook.com/LevelUpSystem" className="social-icon">
