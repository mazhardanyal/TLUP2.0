          ...
          <div className="footer-section">
            <div className="footer-logo">
              ...
              <div className="logo-text">
                <span className="logo-academy">Level Up</span>
                <span className="logo-school">School</span>
              </div>
            </div>
            <p className="footer-description">
              Nurturing young minds for a brighter tomorrow. Excellence in education since 1995.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-contact">
              <li>
                ...
                <span>123 Education Ave, Knowledge City, KC 12345</span>
              </li>
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.362 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <span>03151234567</span>
              </li>
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <span>info@levelupschool.edu</span>
              </li>
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
